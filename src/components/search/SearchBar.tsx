    ...
    <div className="sm:flex hidden bg-white shadow-lg border border-gray-100 p-4 rounded-2xl transition-all duration-200 hover:shadow-xl max-w-4xl mx-auto relative items-center gap-4">
      ...
      <div className="relative flex-1 min-w-[180px]">
        ...
        <input
          ...
          placeholder="City"
          className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 focus:border-greentheme focus:ring-2 focus:ring-greentheme/20 outline-none transition-all duration-200 font-medium placeholder:text-gray-400"
          onFocus={handleCityFocus}
          onBlur={handleCityBlur}
        />
        {citySuggestions.length > 0 && isCityFocused && (
          <ul
            className="absolute left-0 right-0 mt-2 bg-white shadow-2xl rounded-xl overflow-hidden z-30 max-h-[250px] overflow-y-auto"
            role="listbox"
          >
            <div className="p-3 border-b border-gray-100">
              <p className="font-semibold text-gray-800 text-sm">Cities</p>
            </div>
            {citySuggestions.map((suggestion) => (
              <li
                key={suggestion}
                className="px-3 py-2.5 hover:bg-gray-50 flex items-center cursor-pointer transition-colors duration-150 border-b border-gray-50 last:border-0"
      ...
      <div className="relative flex-1 min-w-[180px]">
        ...
        {suggestions.length > 0 && isFocused && (
          ...
          >
            <div className="p-3 border-b border-gray-100">
              <p className="font-semibold text-gray-800 text-sm">Suggestions</p>
            </div>
