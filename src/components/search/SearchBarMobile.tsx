...
const SearchBarMobile = () => {
  ...
  return (
    <div className="p-4 sm:hidden relative bg-whitetheme dark:bg-darkthemeitems block rounded-2xl shadow-sm dark:shadow-[0_1px_3px_0_rgba(255,255,255,0.05)] transition-colors">
      {/* City Button */}
      <button
        onClick={() => {
          setIsCity(true)
        }}
        className="flex w-full items-center p-3 rounded-xl bg-whitetheme dark:bg-bgdarktheme2 text-gray-700 dark:text-textdarktheme border border-gray-200 dark:border-textdarktheme/10 shadow-sm hover:border-greentheme/50 dark:hover:border-greentheme/30 transition-all duration-200 mb-3"
      >
        ...
        <span className="text-gray-400 dark:text-textdarktheme/50">
      ...
      {isCity && (
        <div className="relative">
          ...
          {/* Modal */}
          <div className="fixed inset-x-0 bottom-0 z-[60] rounded-t-3xl bg-whitetheme dark:bg-bgdarktheme shadow-2xl dark:shadow-[0_-10px_25px_-5px_rgba(0,0,0,0.3)] max-h-[85vh] overflow-hidden transition-transform duration-300 transform">
            {/* Modal Header */}
            <div className="sticky top-0 bg-whitetheme dark:bg-bgdarktheme z-10 px-5 py-4 border-b border-gray-100 dark:border-textdarktheme/10 flex items-center justify-between">
              <h1 className="text-xl font-bold text-gray-800 dark:text-textdarktheme">Select City</h1>
              <button
                onClick={() => {
                  setIsCity(false)
                }}
                className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-100 dark:bg-darkthemeitems text-gray-500 dark:text-textdarktheme/70 hover:bg-gray-200 dark:hover:bg-bgdarktheme2 transition-colors"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <div className="p-5 overflow-y-auto max-h-[calc(85vh-70px)] bg-whitetheme dark:bg-bgdarktheme">
              ...
              <div className="relative mb-4">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3.5 rounded-xl border border-gray-200 dark:border-textdarktheme/10 focus:border-greentheme focus:ring-2 focus:ring-greentheme/20 outline-none transition-all bg-whitetheme dark:bg-darkthemeitems text-blacktheme dark:text-textdarktheme placeholder:text-gray-400 dark:placeholder:text-textdarktheme/50"
                />
              </div>

              {/* Suggestions List */}
              <div className="mt-2">
                <h3 className="font-semibold text-gray-800 dark:text-textdarktheme mb-2 px-1">Cities</h3>
                <ul className="space-y-1" role="listbox">
                  {citySuggestions.map((suggestion) => (
                    <li
                      key={suggestion}
                      className="px-3 py-3 hover:bg-gray-50 dark:hover:bg-darkthemeitems flex items-center cursor-pointer rounded-xl transition-colors duration-150"
      ...
      {isSearch && (
        <div className="relative">
          ...
          <div className="fixed inset-x-0 bottom-0 z-[60] rounded-t-3xl bg-whitetheme dark:bg-bgdarktheme shadow-2xl dark:shadow-[0_-10px_25px_-5px_rgba(0,0,0,0.3)] max-h-[85vh] overflow-hidden transition-transform duration-300 transform">
            {/* Modal Header */}
            <div className="sticky top-0 bg-whitetheme dark:bg-bgdarktheme z-10 px-5 py-4 border-b border-gray-100 dark:border-textdarktheme/10 flex items-center justify-between">
              <h1 className="text-xl font-bold text-gray-800 dark:text-textdarktheme">Search</h1>
              <button
                onClick={() => {
                  setIsSearch(false)
                }}
            ...
            <div className="p-5 overflow-y-auto max-h-[calc(85vh-70px)] bg-whitetheme dark:bg-bgdarktheme">
              ...
              {/* Suggestions List */}
              <div className="mt-2">
                <h3 className="font-semibold text-gray-800 dark:text-textdarktheme mb-2 px-1">Suggestions</h3>
                <ul className="space-y-1" role="listbox">
