...
import RestaurantImage from "../../assets/restaurant-owner.jpg"

function JoinSection() {
  return (
    <section className="w-full px-4 py-16 md:py-24 lg:py-32">
      <div className="container mx-auto max-w-7xl">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center text-greentheme mb-8 md:mb-12">
